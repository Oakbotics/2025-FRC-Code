...
public class IntakeClearanceInCommand extends SequentialCommandGroup {
  public IntakeClearanceInCommand(
      ElevatorSubsystem m_elevatorSubsystem, WristSubsystem m_wristSubsystem) {
    addCommands(
        new ElevatorPositionCommand(
            m_elevatorSubsystem, MotionConstants.intakeClearanceIn.get("elevator").doubleValue()),
        new WristPositionCommand(
            m_wristSubsystem, MotionConstants.intakeClearanceIn.get("wrist").doubleValue()));
  }
}
