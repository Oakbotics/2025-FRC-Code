...
public class Right25PieceATR extends SequentialCommandGroup {
    public Right25PieceATR(DriveSubsystem m_driveSubsystem, ElevatorSubsystem m_elevatorSubsystem, WristSubsystem m_wristSubsystem, IntakeSubsystem m_intakeSubsystem, LimeLightSubsystem m_limelightSubsystem){
        if(DriverStation.getAlliance().get() == Alliance.Blue)
            addCommands(
                ...
                new ParallelCommandGroup(
                    m_driveSubsystem.findPathToPose(FieldConstants.aprilTagPosition.get(22)),
        ...
        addCommands(
                ...
                new RunCommand(() -> m_driveSubsystem.limeLightPoseUpdate()).withTimeout(0.1),
                new ParallelCommandGroup(
                    m_driveSubsystem.findPathToPose(FieldConstants.aprilTagPosition.get(9)),
                    new L3ScoreCommandGroup(m_elevatorSubsystem, m_wristSubsystem)
                ),
                new ParallelCommandGroup(
                    new L4ScoreCommandGroup(m_elevatorSubsystem, m_wristSubsystem),
