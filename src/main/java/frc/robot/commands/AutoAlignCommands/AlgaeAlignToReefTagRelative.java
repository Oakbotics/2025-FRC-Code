...
public class AlgaeAlignToReefTagRelative extends Command {
  ...
  private double Y_TOLERANCE_REEF_ALIGNMENT = 0.00;
  private double ROT_TOLERANCE_REEF_ALIGNMENT = 3.5;

  private String limelightUsed;
  double[] positions;

  public AlgaeAlignToReefTagRelative(boolean isRight, DriveSubsystem m_driveSubsystem, LimeLightSubsystem m_limeLightSubsystem) {
  ...
  public void initialize() {
    if(m_limeLightSubsystem.getRightID() != -1 && isRight == false){
      ...
      Y_LEFT_SETPOINT_REEF_ALIGNMENT = 0.0; 
      Y_RIGHT_SETPOINT_REEF_ALIGNMENT = 0.0; 
