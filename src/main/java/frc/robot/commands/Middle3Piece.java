...
public class Middle3Piece extends SequentialCommandGroup {
    public Middle3Piece(DriveSubsystem m_driveSubsystem, ElevatorSubsystem m_elevatorSubsystem, WristSubsystem m_wristSubsystem, IntakeSubsystem m_intakeSubsystem){
        addCommands(
            ...
            new InstantCommand(() -> m_driveSubsystem.resetOdometry(new Pose2d(FieldConstants.reefPolePositions.get(10)[1].getX() + 1, FieldConstants.reefPolePositions.get(10)[1].getY(), Rotation2d.fromDegrees(180.0)))),
