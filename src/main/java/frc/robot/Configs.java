...
public final class Configs {
  ...
  public static final class ElevatorConfigs {
    ...
    static {
      ...
      elevatorConfig.closedLoopRampRate(0.1).idleMode(IdleMode.kBrake).smartCurrentLimit(30);
      elevatorConfig.encoder.positionConversionFactor(360).velocityConversionFactor(1);
  ...
  public static final class CoralConfigs {
    ...
    static {
      coralConfig.idleMode(IdleMode.kBrake).smartCurrentLimit(40);
    }
  }
